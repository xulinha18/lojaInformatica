<?php
    ...
    $sql = "UPDATE `produtos` SET `numeroProduto`='$numeroProduto',`nomeProduto`='$nomeProduto',
    `qtdProduto`='$qtdProduto',`catProduto`='$catProduto',`fornProduto`='$fornProduto' WHERE 1";
